...
<body>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_PT/sdk.js#xfbml=1&version=v9.0"
        nonce="1zfeFvK5"></script>
    ...
    <div class="box-collapse">
        ...
        <div class="box-collapse-wrap form">
            ...
            {{ Form::open(['route' => 'imoveis.index', 'method' => 'GET', 'class' => 'form-a']) }}
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipo_negocio" class="form-control form-control-lg form-control-a" id="Type">
                            ...
                            <option @if (isset($_GET['tipo_negocio']) and $_GET['tipo_negocio'] == 'Arrendamento') selected @endif value="Arrendamento">Arrendamento
                            </option>
                        ...
                        <select name="localidade" class="form-control form-control-lg form-control-a" id="localidade">
                            ...
                            @if (isset($localidades))
                                ...
                                @foreach ($localidades as $key => $value)
                                    <option @if (isset($_GET['localidade']) and $_GET['localidade'] == $key) selected @endif
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link {{ (request()->is('/') or request()->is('home')) ? 'active' : '' }}"
                            href="{{ url('/') }}">Início</a>
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link {{ request()->is('sobre') ? 'active' : '' }}"
                            href="{{ url('sobre') }}">Quem somos</a>

                    </li>

                    <li class="nav-item">

                        <a class="nav-link {{ request()->is('imoveis') ? 'active' : '' }}"
                            href="{{ url('imoveis') }}">Imóveis</a>
                    ...
                    @if (Auth::user())
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/admin/denuncias') }}">
                                Denúncias
                            </a>
                        </li>
                    ...
                    @foreach ($imoveis as $imovel)
                        @if ($imovel->fotos()->count())
                            <div class="carousel-item-a intro-item bg-image"
                                style="background-image: url(/fotos_imoveis/{{ $imovel->fotos()->first()->filename }})">
                                                    ...
                                                    <div class="intro-body">
                                                        ...
                                                        <a href="{{ url('imoveis', $imovel->id) }}">
                                                            ...
                                                            <h1 class="intro-title mb-4">
                                                                ...
                                                                <span class="color-b">{{ $imovel->natureza }} -
                                                                    {{ $imovel->tipologia }} </span>
                                                                {{ $imovel->ref_localidade->nome_localidade }} <br>
                                                        ...
                                                        <p class="intro-subtitle intro-price">
                                                            ...
                                                            <a href="{{ url('imoveis', $imovel->id) }}"><span
                                                                    class="price-a">{{ $imovel->tipo_negocio }} |
                    ...
                    <div class="widget-a">
                        ...
                        <div class="w-body-a">
                            ...
                            <p class="w-text-a color-text-a">
                                ...
                                Manuel Paulino Borges - Vest. Unip. Lda. <br>Licença Nº. - 18159<br>NIF - 513 978
                                690<br>Morada - Rua Dr.ª Emília Salvado Borges 32, 7940-007 Cuba
                        ...
                        <div class="w-body-a">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="color-a">
                                    ...
                                    <span class="color-text-a"><i class="far fa-envelope"></i> </span>
                                    mborgesimobiliaria@gmail.com
                                </li>

                                <li class="color-a">

                                    <span class="color-text-a"><i class="fa fa-phone"></i> </span> (+351) 962 548 074
                                </li>
                            ...
                            <div class="fb-like" data-href="http://www.mborgesimobiliaria.pt/" data-width=""
                ...
                <div class="col-md-12">
                    ...
                    <nav class="nav-footer">
                        ...
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <a href="{{ url('/denuncias') }}">Canal de Denúncias</a>
                            </li>
                    ...
                    <div class="copyright-footer">
                        ...
                        <p class="copyright color-text-a">
                            ...
                            <span class="color-a">MBorges Lda</span> All Rights Reserved.
